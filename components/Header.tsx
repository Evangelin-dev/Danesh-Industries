        ...
        <nav className="hidden lg:flex items-center space-x-2 xl:space-x-4">
          ...
          <div className="relative">
            <button
              ...
              className="menu-item-base font-medium px-3 py-2 rounded-md border border-gray-300 hover:border-brand-blue transition-colors duration-300 flex items-center"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 0 24">
